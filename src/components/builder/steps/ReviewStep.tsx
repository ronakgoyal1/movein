...
export function ReviewStep() {
  const { collegeId, cart, getTotal, getItemCount, setStep, removeFromCart, addToCart, getItemPrice, getCategoryCompletion, setActiveProduct } = useBuilderStore();
    ...
    <div>
      ...
      <div className="p-4 bg-surface border border-border rounded-lg mb-6">
        <div className="flex items-center justify-between mb-1">
          ...
          <button onClick={() => setStep("college")} className="text-[0.75rem] text-accent hover:underline flex items-center gap-1">
